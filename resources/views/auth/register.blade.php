...
-o-background-size: cover;">
    ...
    <div class="signup-box">
        ...
        <div class="card">
            <div class="body">
                <form id="sign_up" method="POST" action="{{ route('sregister') }}">
                    <div class="msg"  style="font-weight: bold;">Création de compte</div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="email" class="form-control" name="login" placeholder="Identifiant (Email)" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="number" class="form-control" name="phone" minlength="8" placeholder="Téléphone" required>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                        ...
                        <div class="form-line">
                            <input type="password" class="form-control" name="pass" minlength="6" placeholder="Nouveau mot de passe" required>
                        </div>
                    </div>
