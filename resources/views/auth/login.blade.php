...
<body class="login-page" style="background-image : url('portailits.png');  background-repeat: repeat; background-size: cover; -webkit-background-size: cover;
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="{{ route('loginS') }}">
                    ...
                    <div class="msg"  style="font-weight: bold; font-size: 25px">Bienvenue à {{ config('app.name')}}</div>
                    ...
                    <div class="row m-t-15 m-b--20">
                        <div class="col-xs-6">
                           <a  style=" margin-top: 5px; font-weight: bold;"
                        class="  waves-effect" 
                         href="{{ route('register') }}">  Création de compte </a>
                        </div>
