	...
	<div class="container-fluid">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <button type="button" style="margin-right: 30px; float: right; padding-right: 30px; padding-left: 30px;" class="btn bg-deep-orange waves-effect" data-color="deep-orange" data-toggle="modal" data-target="#add">PROGRAMMER</button>
                       		</h2>
                        </div>
                        <div class="body">
                        	<div class="table-responsive" data-pattern="priority-columns">
								<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
									...
									<tbody>
                                        ...
                                        <tr>
                                            <td>
                                                {{$maint->periodedebut}} au {{$maint->periodefin}}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                data-toggle="modal" data-target="#etatmaintenance" onclick="setetatmaintenance({{$maint->id}}, '{{$maint->periodedebut}} au {{$maint->periodefin}}')">
                                                <i class="material-icons">gps_fixed</i></a> </button> {{$maint->etat}}
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <button type="button" title="EXCEL"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onClick="javascript:window.open('{{ route("EMPC") }}?id={{$maint->id}}');">
                                            ...
                                            <button type="button" title="Liste"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light" onClick="javascript:window.open('{{ route("GMDPC") }}?id={{$maint->id}}');">
                                            ...
                                            data-toggle="modal" data-target="#update" onclick="setupdatemaintenance({{$maint->id}}, '{{$maint->periodedebut}}', '{{$maint->periodefin}}', {{$maint->user}}, '{{App\Providers\InterfaceServiceProvider::LibelleUser($maint->user)}}')">
                                            ...
                                            data-toggle="modal" data-target="#deletemaintenance" onclick="setdeletemaintenance({{$maint->id}}, '{{$maint->periodedebut}} {{$maint->periodefin}}')">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="4"><center>Pas de maintenance enregistrer!!!</center> </td>
                                        </tr>
                                        @endforelse
                                    </tbody>
								</table>
        ...
        <script type="text/javascript">
            ...
            async function validemaintenance(){
                ...
                if(ucm == 0)
                    document.getElementById('infomaintenance').innerHTML = "<div class='alert alert-danger alert-block'>Veuillez sélectionner un administrateur pour gérer la maintenance.. </div>";
                else{
                    dat = {
                        _token: token,
                        pdm: pdm,
            ...
            async function setdeletemaintenance(id, periode){
                document.getElementById('infodelete').innerHTML = "Vous voulez vraiment supprimer la période de la maintenance suivant : "+periode+" ?";
            ...
            async function setupdatemaintenance(id, periodedebut, periodefin, user, nameuser) {
                ...
                document.getElementById('ucma').innerHTML = "Utilisateur en charge : <br> Voulez-vous changer l'utilisateur actuel `"+nameuser+"` ? Si oui choisissez..";
            }
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                            <div class="form-line">
                                <input type="date" id="pdm" name="pdm" class="form-control" placeholder="">
                            </div>
                           </div>
                        </div>
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                            <div class="form-line">
                                <input type="date" id="pfm" name="pfm" class="form-control" placeholder="">
                            </div>
                           </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                            <div class="form-line">
                                ...
                                @endphp 
                                <select type="text" id="ucm" name="ucm" class="form-control" multiple="true">
                                    <option value="0">Sélectionner un ou plusieurs utilisateurs</option>
                                    @foreach($allUser as $user)
                                        <option value="{{ $user->idUser}}"> {{ $user->nom}} {{ $user->prenom}} </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6">
                            <label for="ucm">Service / Direction concernés :</label>
                           <div class="form-group">
                            <div class="form-line">
                                @php 
                                    $allUser = App\Providers\InterfaceServiceProvider::alladminandsuperadmin();
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            <label for="ucm">Contenu mail :</label>
                           <div class="form-group">
                            <div class="form-line">
                                <textarea type="text" id="ucm" name="ucm" class="form-control"></textarea>
                            </div>
                           </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                            <div class="form-line">
                                <input type="date" id="pdmu" name="pdmu" class="form-control" placeholder="">
                            </div>
                           </div>
                        </div>
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                            <div class="form-line">
                                <input type="date" id="pfmu" name="pfmu" class="form-control" placeholder="">
                            </div>
                           </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="commentmaintenance" name="commentmaintenance" class="form-control">
                            </div>
                            </div>
                        </div>
                    </div>
