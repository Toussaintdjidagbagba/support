        ...
        <div class="body-content">
            ...
            <table>
                ...
                <tbody>
                    @foreach ($list as $inc)
                        <tr>
                            <td style="vertical-align:middle; text-align: left; width: 130px;"><b>{{ $inc['periode'] }}</b></td>
                            ...
                            <td style="vertical-align:middle; text-align: left; width: 120px;">{{ $inc['avisuser'] ?? 'N/A' }}</td>
