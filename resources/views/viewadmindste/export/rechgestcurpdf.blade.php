        ...
        <div class="body-content">
            ...
            <table>
                ...
                <tbody>
                    @foreach ($list as $inc)
                        <tr>
                            <td style="vertical-align:middle; text-align: left; width: 120px;"><b>{{ $inc['date_debut'] }}</b></td>
                            <td style="vertical-align:middle; text-align: left; width: 100px;">{{ $inc['heures'] ?? 'N/A' }}</td>
                            <td style="vertical-align:middle; text-align: left; width: 180px;">{{ $inc['nameoutils'] ?? 'N/A' }}</td>
                            <td style="vertical-align:middle; text-align: left; width: 220px;">{{ $inc['usersL'] ?? 'N/A' }}</td>
                            <td style="vertical-align:middle; text-align: left; width: 120px;">{{ $inc['etat'] ?? 'N/A' }}</td>
                        </tr>
                    @endforeach
