                    ...
                    <div class="header">
                        <h2>
                            ...
                            <button type="button"
                                ...
                                data-target="#addavis">Ajouter</button>
                        </h2>
                    </div>
                    <div class="body">
                    ...
                    <div class="header">
                        <h2>
                            ...
                            <button type="button"
                                style="margin-right: 30px; float: right; padding-right: 30px; padding-left: 30px;"
                                class="btn bg-deep-orange waves-effect" data-color="deep-orange" data-toggle="modal"
                                data-target="#addetat">Ajouter</button>
                        </h2>
                    </div>
                    <div class="body">
                        <div class="table-responsive" data-pattern="priority-columns">
                            <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                ...
                                <tbody>
                                                ...
                                                <td>
                                                    @if (in_array('update_menu', session('auto_action')))
                                                        <button type="button" title="Modifier"
                                                            onclick="setupdate(event,'{{ $men->id }}','{{ $men->type }}','{{ $men->libelle }}')"
                                                            data-toggle="modal" data-target="#updates"
                                                            class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><i
                                                                class="material-icons">system_update_alt</i>
                                                        </button>
                                                    @endif
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3">
                                                <center>Pas d'états enregistrer!!!</center>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
