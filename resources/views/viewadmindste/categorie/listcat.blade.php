                                            ...
                                            <td>
                                                @if (in_array('update_cat', session('auto_action')))
                                                    <button type="button" title="Modifier"
                                                        ...
                                                        <a href="{{ route('MTC', $cat->id) }}" style="color:white;"> <i
                                                ...
                                                @if (in_array('delete_cat', session('auto_action')))
                                                    <button type="button" title="Supprimer" style="color:white;"
                                                        ...
                                                        onclick="DeleteH(event, '{{ route('DC') }}','{{ $cat->libelle }}')"
    ...
    <script type="text/javascript">
        async function DeleteH(event, url, libelle) {
            ...
            const {
                ...
                title: "Êtes-vous sûr de vouloir supprimer la catégorie " + libelle + "?",
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" id="temp" name="tempmin" class="form-control"
                                            placeholder="">
                                    </div>
                                </div>
                            </div>
