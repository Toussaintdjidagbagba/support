	...
	<div class="container-fluid">
								...
								<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
									...
									<tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{App\Providers\InterfaceServiceProvider::LibelleUser($out->user)}}</td>
                                            <td>
                                                ...
                                                data-toggle="modal" data-target="#etatoutil" onclick="setetatoutils({{$out->id}}, '{{$out->nameoutils}}')">
                                                <i class="material-icons">gps_fixed</i></a> </button> {{$out->etat}}
                                                @endif
                                            </td>
                                            <td>
                                                @if($out->user == null || $out->user == "")
                                                    @if(in_array("affecte_outil", session("auto_action")))
                                                    <button type="button" title="Affecter"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"
                                                    data-toggle="modal" data-target="#affecter" onclick="setutilisateurinoutils({{$out->id}}, '{{$out->nameoutils}}')">
                                                        <i class="material-icons">account_circle</i>
                                                    </button>
                                                    @endif
                                                @else
                                                    @if(in_array("reaffecte_outil", session("auto_action")))
                                                    <button type="button" title="Reaffecter"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"
                                                    data-toggle="modal" data-target="#reaffecter" onclick="updateuserinoutils({{$out->id}}, '{{$out->nameoutils}}', {{$out->user}}, '{{App\Providers\InterfaceServiceProvider::LibelleUser($out->user)}}')">
                                                        <i class="material-icons">account_circle</i>
                                                    </button>
                                                    @endif
                                                @endif
                                            ...
                                            data-toggle="modal" data-target="#historique" onclick="gethistorique({{$out->id}}, '{{$out->nameoutils}}')">
                                                <i class="material-icons">assessment</i> 
                                            </button>
                                            @endif
                                            @if(in_array("caract_outil", session("auto_action")))
                                            <button type="button" title="Détails"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"
                                            data-toggle="modal" data-target="#details" onclick="getdetail({{$out->id}}, '{{$out->nameoutils}}', '{{$out->otherjson}}', {{$out->categorie}})">
                                            ...
                                            data-toggle="modal" data-target="#update" onclick="setupdateoutils({{$out->id}}, '{{$out->nameoutils}}', '{{$out->otherjson}}', {{$out->categorie}})">
                                            ...
                                            data-toggle="modal" data-target="#deleteoutil" onclick="setdeleteoutils({{$out->id}}, '{{$out->nameoutils}}')">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="5"><center>Pas d'outils enregistrer!!!</center> </td>
                                        </tr>
                                        @endforelse
                                    </tbody>
								</table>
        ...
        <script type="text/javascript">
            ...
            async function controlecat() {
                ...
                if(catchoisi == 0)
                    document.getElementById('infosaveoutil').innerHTML = "<div class='alert alert-danger alert-block'>Veuillez sélectionner une catégorie d'outil avant de continuer.. </div>";
                else{
                    ...
                    try {
                        ...
                        if(response.status == 200)
                        {
                            ...
                            list.forEach(function(currentline, index, arry){
                                ...
                                contenu += '<label for="'+currentline["code"]+'">'+currentline["libelle"]+'</label>';
                                contenu += '<div class="form-group">';
                                contenu += '<div class="form-line">';
                                contenu += '<input type="'+currentline["type"]+'" id="'+currentline["code"]+'" name="'+currentline["code"]+'" class="form-control outiladd" placeholder="">';
                                //contenu += ;
                                contenu += '</div>';
                                contenu += '</div>';
                                contenu += '</div>';
            ...
            async function valideaddoutil(){
                ...
                if(caraccat == 0)
                    ...
                    document.getElementById("infosaveoutil").innerHTML = '<div class="alert alert-warning alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>En cours de traitement.. <br> Veuillez patienter! </strong></div>';
                    ...
                    // En cours d'envoie
                        try {
                            ...
                            {
                                data = await response.text();
                                document.getElementById("infosaveoutil").innerHTML = '<div class="alert alert-success alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>'+data+'</strong></div>';
                                ...
                                document.getElementById("infosaveoutil").innerHTML = '<div class="alert alert-danger alert-block"> <button type="button" class="close" data-dismiss="alert">×</button><strong>Une erreur s\'est produite </strong></div>';
                            }
                        } catch (error) {
            ...
            function addusers(){
                document.getElementById('infoaffectation').innerHTML = "Vous voulez ajouter un utilisateur qui n'existe pas ? Dans cinq secondes vous serez redirigez vers la page d'enregistrement d'utilisateur.. ";
                setTimeout(function(){
            ...
            async function valideaffectationoutil() {
                ...
                document.getElementById("infoaffectation").innerHTML = '<div class="alert alert-warning alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>En cours de traitement.. <br> Veuillez patienter! </strong></div>';
                ...
                // En cours d'envoie
                    try {
                        ...
                        {
                            data = await response.text();
                            document.getElementById("infoaffectation").innerHTML = '<div class="alert alert-success alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>'+data+'</strong></div>';
                            document.getElementById("caraclib").value = "";
                            setTimeout(function(){
                                               window.location.reload();
                                        }, 3000);
                            ...
                            document.getElementById("infoaffectation").innerHTML = '<div class="alert alert-danger alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>Une erreur s\'est produite </strong></div>';
                        }
                    } catch (error) {
            ...
            async function updateuserinoutils(id, outil, user, nameuser) {
                ...
                try {
                        ...
                        if(response.status == 200)
                        {
                            ...
                            list.forEach(function(currentline, index, arry){
                                contenu += '<option value="'+currentline["idUser"]+'">'+currentline["nom"]+' '+currentline["prenom"]+'</option>';
                            }); 
                            contenu += '</select>';
            ...
            async function validereaffectationoutil() {
                ...
                document.getElementById("inforeaffectation").innerHTML = '<div class="alert alert-warning alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>En cours de traitement.. <br> Veuillez patienter! </strong></div>';
                ...
                // En cours d'envoie
                    try {
                        ...
                        {
                            data = await response.text();
                            document.getElementById("inforeaffectation").innerHTML = '<div class="alert alert-success alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>'+data+'</strong></div>';
                            setTimeout(function(){
                                               window.location.reload();
                                        }, 3000);
                        }else{
                            document.getElementById("inforeaffectation").innerHTML = '<div class="alert alert-danger alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>Une erreur s\'est produite </strong></div>';
                        }
                    } catch (error) {
                ...
                document.getElementById('infohistoriqueoutils').innerHTML = "L'historique de "+outil+" : ";
                    try {
                        ...
                        if(response.status == 200)
                        {
                            ...
                            if(contenu == "")
                                document.getElementById('contenuhist').innerHTML = '<tr> <td colspan="2"><center> Aucune action effectuée sur cet outil. </center> </td> </tr>';
                            else
            ...
            async function valideetatoutil(){
                ...
                commentoutil = document.getElementById("commentoutil").value;
                    ...
                    document.getElementById("infoetat").innerHTML = '<div class="alert alert-warning alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>En cours de traitement.. <br> Veuillez patienter! </strong></div>';
                    ...
                    // En cours d'envoie
                        try {
                            ...
                            {
                                data = await response.text();
                                document.getElementById("infoetat").innerHTML = '<div class="alert alert-success alert-block"><button type="button" class="close" data-dismiss="alert">×</button><strong>'+data+'</strong></div>';
                                setTimeout(function(){
                                               window.location.reload();
                                        }, 3000);
                            }
                            else{
                                document.getElementById("infoetat").innerHTML = '<div class="alert alert-danger alert-block"> <button type="button" class="close" data-dismiss="alert">×</button><strong>Une erreur s\'est produite </strong></div>';
                            }
                        } catch (error) {
                    ...
                    <div class="row clearfix">
                        <div class="col-md-4">
                           ...
                           <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="caracrefoutil" name="caracrefoutil" class="form-control" placeholder="">
                            </div>
                           </div>
                        </div>
                        <div class="col-md-4">
                           ...
                           <div class="form-group">
                            <div class="form-line">
                                <input type="date" id="caracdateoutil" name="caracdateoutil" class="form-control" placeholder="">
                            </div>
                           </div>
                        </div>
                        <div class="col-md-4">
                           ...
                           <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="caraclib" name="caraclib" class="form-control" placeholder="">
                            </div>
                           </div>
                        </div>
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                            <div class="form-line">
                                ...
                                @endphp 
                                <select type="text" id="caraccat" name="caraccat" class="form-control" onchange="controlecat()">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6">
                            <button class="bg-blue-grey btn-circle btn-lg margin-bottom-10 waves-effect waves-light" onclick="addusers()">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12" id="seehistoutil">
                            <div class="table-responsive" data-pattern="priority-columns">
                                <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                    <thead>
                                        <button type="button" style="float: right;" class="btn bg-deep-orange waves-effect">
...
<div class="modal fade" id="details" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" onclick="exportdetailpdf()" id="export-pdf-detail" class="btn btn-danger waves-effect">
                    Exporter en PDF
                </button>
                <button type="button" class="btn btn-default btn-sm waves-effect waves-light" data-dismiss="modal">FERMER</button>
