    ...
    <body class="theme-deep-blue">
        ...
        <section>
            ...
            <aside id="leftsidebar" class="sidebar">
                <!-- User Info -->
                <div class="user-info"
                    style="background-image : url('fondprofil.png'); background-repeat: no-repeat; background-size: cover; -webkit-background-size: cover;
            -moz-background-size: cover; -o-background-size: cover;">
                    <div class="image">
                        @if (session('utilisateur')->image != '')
                            <img src="{{ asset('images/' . session('utilisateur')->image) }}" alt="Image de profil"
                                width="58" height="58" style="border-radius: 50%">
                        @else
                            <img src="cssdste/images/user.png" width="48" height="48" alt="User" />
                        @endif
                    </div>
                    <div class="info-container">
                        <div style="color:#001e60" class="name" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">{{ session('utilisateur')->nom }} {{ session('utilisateur')->prenom }}
                        </div>
                        <div style="color:#001e60" class="email">{{ session('utilisateur')->mail }}</div>
                        <div class="btn-group user-helper-dropdown">
                            <i style="color:#001e60" class="material-icons" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="true">keyboard_arrow_down</i>
                            <ul class="dropdown-menu pull-right">
                                <li><a href="javascript:void(0);"><i class="material-icons">person</i>Profil</a></li>
                                <li role="separator" class="divider"></li>
                                <li><a href="{{ route('logout') }}"><i class="material-icons">input</i>Déconnecter</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="legal">
                    <div class="copyright">
                        &copy; {{ strtoupper(strftime('%B %Y')) }} <a
